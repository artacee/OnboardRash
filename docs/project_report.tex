...
\textbf{Platform:} & Raspberry Pi 5 (Edge) + Flask Server (Cloud) \\
...
\midrule
Microcontroller & Raspberry Pi 5 (2GB) & Main processing unit \\
IMU & MPU-6050 & 3-axis accelerometer (X/Y/Z in G-force) \\
GPS & Driver's Phone (Companion App) & Location \& speed via WiFi hotspot at 2Hz \\
Camera & USB Webcam (720p/1080p) & Front-facing, plug-and-play via USB 3.0 \\
...
\midrule
Edge (Pi) & Python 3, smbus2, OpenCV (opencv-python-headless), Kalman Filter \\
